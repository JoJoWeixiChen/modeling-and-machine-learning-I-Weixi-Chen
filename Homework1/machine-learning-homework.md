...
From the comparison of the linear classifier and the more flexible
classifier, we can find out that the more flexible one has a relatively
low bias, as it makes less wrong decision towards different data.
However, the more flexible classifier has a high variance, as the
